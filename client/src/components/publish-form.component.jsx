...
const PublishForm = () => {
  ...
  const handlePublish = (e) => {
    ...
    if (postType.type === "upload") {
      ...
      // Directly append body as a JSON string to FormData
      formData.append('body', JSON.stringify(blog.body)); // Assuming blog.body is already a valid JSON string
