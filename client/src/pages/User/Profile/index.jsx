...
import { Link, Routes, Navigate, Route, useNavigate, useMatch } from 'react-router-dom';
    ...
    return (
        <Fragment>
            {!noData ? (
                !loading ? (
                    <>
                        {type.route === "#threads" && <Threads userData={userData} />}
                        {type.route === "#answers" && <Answers userData={userData} />}
                        {type.route === "#bans" && <Bans userData={userData} />}
                        {type.route === "#authHistory" && <AuthHistory userData={userData} />}
                                ...
                                <CardBody>
                                    <div className="profile_head">
                                        ...
                                        {user.role >= 2 && user.id !== userData._id ? (
                                            <Dropdown>
                                                ...
                                                {user.role > userData.role && (
                                                    <>
                                                        ...
                                                        <Link to={'/user/' + userData.name + '#authHistory'} className="dropdown_item">
                                            ...
                                            <Dropdown>
                                                <Link to={'/user/' + user.name + '#authHistory'} className="dropdown_item">
                                                    {Strings.authorizationsHistory[lang]}
                                                </Link>
                                            </Dropdown>
                                        ) : null}
